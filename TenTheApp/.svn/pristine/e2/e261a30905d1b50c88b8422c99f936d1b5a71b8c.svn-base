...
public class PopularPostAdapter extends RecyclerView.Adapter<PopularPostAdapter.ViewHolder> {
    ...
    Context context;
    ArrayList<NewsFeedOutput.Posts> mList;
    PopularFragment popularPostListFragment;
    private SharedPrefsHelper sharedPrefsHelper;

    public PopularPostAdapter(PopularFragment context, ArrayList<NewsFeedOutput.Posts>  mList) {
        this.mList = mList;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        if (postData.getPostTypeImage() || (postData.getVideoUrl() != null && postData.getVideoUrl().length() > 0)) {
            viewHolder.captionTextView.setText("");
            viewHolder.mediaCaption.setText(postData.getText());
...
//                    bundle.putParcelable("post_data",mList.get(position));
                    ...
                    popularPostListFragment.replaceChildFragment(R.id.popularLayout, new PostDetailFragment(), bundle);
            ...
            public void onResponse(Call<UnFollowResponse> call,
                ...
                if (response != null && response.body() != null) {
                    if (response.body().getSuccess().contains("true")) {
                        ...
                        //to-do
                        MediaPlayer mp = MediaPlayer.create(context, R.raw.ticksound);
                        mp.start();
