...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        String isPrivate = mList.get(position).getIsPrivate();
        if (isPrivate != null && isPrivate.contains("true")) {
            viewHolder.mUserImagView.setImageDrawable(mActivity.getResources().getDrawable(R.drawable.myprofilelarge));
        } else {
                ...
                switch (view.getId()) {
                    case R.id.rl_follow:
                        if (mBaseFragment == null) {
                            ...
                            mBaseFragment.replaceChildFragment(R.id.frame_layout_search, new NewProfileFragment(), bundle);
                        }
                        break;
