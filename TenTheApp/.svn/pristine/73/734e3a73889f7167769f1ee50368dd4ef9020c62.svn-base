...
public class ForgotPasswordActivity extends BaseActivity implements View.OnClickListener, AppCommonCallback, ResetForgotPassPhonePresenter.ResetForgotPassPhoneCallback, ResetForgotPassEmailPresenter.ResetForgotPassEmailCallback {
