...
public class PhoneOtpVerifyActivity extends BaseActivity implements View.OnClickListener, TextWatcher, AppCommonCallback, ResultCallbacks.PhoneOtpVerifyCallback, ResultCallbacks.ResendPhoneOtpCallback, PhoneSignUpPresenter.SignupCallback {
    ...
    protected int getLayoutId() {
        return R.layout.activity_phone_otp_verify;
    }
    ...
    public void afterTextChanged(Editable s) {
        if (codeEdtTxt.getText().toString().trim().length() == 0) {
