...
import com.nvcomputers.ten.views.auth.PhoneVerificationForgetPasswordActivity;
...
public class CountryCodeAdapter1 extends RecyclerView.Adapter<CountryCodeAdapter1.ViewHolder> {
    ...
    private PhoneVerificationForgetPasswordActivity mActivity;
    private CountryDialog1 countryDialog;

    public CountryCodeAdapter1(PhoneVerificationForgetPasswordActivity context, ArrayList<?> mList, CountryDialog1 countryDialog) {
