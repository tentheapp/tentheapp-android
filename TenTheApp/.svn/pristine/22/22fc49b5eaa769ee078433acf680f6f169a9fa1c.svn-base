...
public class TimedPostActivity extends Activity implements AppCommonCallback, GetUserStatusPresenter.GetUserStatusCallback {

    private RecyclerView timedPostRecyclerView;
    private TimedPostAdapter mAdapter;
    private SharedPrefsHelper sharedPrefsHelper;
    private ProgressBar progressBar;
    //private List<GetUserStatusResponse.> mArrayList = new ArrayList<>();
    private TimedPostAdapter notificationListAdapter;
    private int offset = 0, count = 0;
    int lastSavedPosition = 0;
    boolean noMoreData = false;
    int currentPageNumber = 1;
    private List<GetUserStatusResponse.Notifications> mArrayList;
...
//    }
    ...
    public void moveToProfile(String username) {
        Intent bundle = new Intent(TimedPostActivity.this, NewProfileActivity.class);
...
//    }
    ...
    public void screenNaigations(ArrayList<GetUserStatusResponse.Post> notificationPostList, Bundle bundle, int clickedPosition) {
        ...
        if (type.contains("COMMENT")) {
            ...
            Intent intent = new Intent(TimedPostActivity.this, NewProfileActivity.class);
            Bundle bundle1 = new Bundle();
            intent.putExtras(bundle1);
            startActivity(intent);
