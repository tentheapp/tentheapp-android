...
/**
 * this class is used to set preview of camera in surface view to capture video.
 */
...
//        addView(mSurfaceView);
    ...
    /**
     * this method is used to set camera parameter according to setting.
     *
     * @param camera
     */
    ...
    /**
     * get max resolution size to click image.
     *
     * @return
     */
    public Size maxSize() {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        // to draw.
        //Utilities.showDLog("surfaceCreated", "Preview----holder---" + holder);
        try {
            if (mCamera != null) {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        //Utilities.showDLog("surfaceDestroyed", "Preview-holder---" + holder);
        if (mCamera != null) {
            //mCamera.stopPreview();
        }
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        //Utilities.showDLog("surfaceChanged", "Preview-holder---" + holder);
        if (mCamera != null) {
            try {
                if (mCamera != null) {
                    mCamera.setPreviewDisplay(holder);
