...
import com.nvcomputers.ten.views.home.RepostedUserListActivity;
...
public class ReposterListAdapter extends RecyclerView.Adapter<ReposterListAdapter.ViewHolder> implements Core {
    ...
    private RepostedUserListActivity mActivity;
    private BaseFragment mBaseFragment;

    public ReposterListAdapter(RepostedUserListActivity context, ArrayList<?> mList) {
