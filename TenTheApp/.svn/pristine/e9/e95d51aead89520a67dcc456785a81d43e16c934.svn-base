...
public class TimedPostAdapter extends RecyclerView.Adapter<TimedPostAdapter.TimedPostViewHolder> {
    ...
    private List<GetUserStatusResponse.Notifications> notificationList;
    private String type;
    private BaseFragment baseFragment;

    public TimedPostAdapter(TimedPostActivity timedPostActivity, List<GetUserStatusResponse.Notifications> mArrayList) {
    ...
    public TimedPostViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TimedPostViewHolder vh = new TimedPostViewHolder(itemView);
        return vh;
    }

    @Override
    public void onBindViewHolder(TimedPostViewHolder holder, int position) {
        GetUserStatusResponse.Notifications data = notificationList.get(position);
        ...
        GetUserStatusResponse.Post postData = data.getPost();//GetUserStatusResponse.Post
        if (postData != null) {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.notification_row:
                    ...
                    GetUserStatusResponse.Post postData = notificationList.get(clickedPosition).getPost();// GetUserStatusResponse.Post
                    ...
                    ArrayList<GetUserStatusResponse.Post> notificationPostList = new ArrayList<>();
