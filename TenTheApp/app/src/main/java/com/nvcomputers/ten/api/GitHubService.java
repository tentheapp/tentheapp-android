...
public interface GitHubService {
    ...
    Call<DeleteAllNotificationResponse> deleteAllNotifications(@Body DeleteAllNotificationInput deleteAllNotificationInput);

    @GET("notification/{idPost}/showAllRepost")
    Call<GroupedRepostDetailResponse> groupedRepostDetail(@Query("idPost") String idPost);

    @GET("allnotification")
    Call<GroupedNotificationDetailResponse> groupedNotification(@Query("user") String userName, @Query("password") String password);

    //@GET("notification")
    //Call<GroupedRepostResponse> groupedRepost(@Query("user") String userName, @Query("password") String password);

    //@GET("notification")
    //Call<GroupedNotificationResponse> groupedNotifications(@Query("user") String userName, @Query("password") String password);
    ...
    Call<ImageCommentOutput> imageComment(@Path("idPost") String idPost);
...
//ungregister
    ...
    Call<FollowingResponse> getFollowersList(@Path("idUser") String idUser, @Query("offset") String offset,
                                             @Query("count") String count);

    @GET("profile/{idUser}/following")
    Call<FollowingResponse> getFollowingList(@Path("idUser") String idUser, @Query("offset") String offset,
                                             @Query("count") String count);
    ...
    Call<GetAllPostCommentOutput> getAllCommentList(@Path("idPost") String idPost, @Query("offset") String offset, @Query("count") String count);
   ...
   /* @Multipart
    ...
    @POST("post/video")
    Call<UploadPost> uploadVideoOnly(@Body VideoPostInput input);
