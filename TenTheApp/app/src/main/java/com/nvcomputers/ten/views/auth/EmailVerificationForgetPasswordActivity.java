...
public class EmailVerificationForgetPasswordActivity extends BaseActivity implements View.OnClickListener, AppCommonCallback, ResultCallbacks.EmailVerificationCallback, ForgotPasswordEmailPresenter.ForgotPassEmailCallback, TextWatcher {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.sendbtn:
                ...
                break;
            case R.id.try_phone:
                Intent intent = new Intent(EmailVerificationForgetPasswordActivity.this, PhoneVerificationForgetPasswordActivity.class);
    ...
    private void validation() {
        ...
        if (cancel) {
            ...
            if (!Utilities.checkInternet(this)) {
                Utilities.showMessage(EmailVerificationForgetPasswordActivity.this, getString(R.string.no_internet_msg));
            } else {
                showDialog();
    ...
    public void onEmailVerifySuccess(Response<EmailVerificationResponse> response) {
        ...
        if (body != null) {
            ...
            if (code.equals("201")) {
                ...
                Intent intent = new Intent(EmailVerificationForgetPasswordActivity.this, OtpEmailVerifyActivity.class);
    ...
    public void onForgotPassEmailSuccess(Response<ForgotPasswordResponse> response) {
        ...
        if (body != null) {
            ...
            if (code.equals("true")) {
                Intent intent = new Intent(EmailVerificationForgetPasswordActivity.this, ForgotPasswordActivity.class);
                intent.putExtra("email_id", mUserEmailAddress);
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (mEmailAddressEditText.getText().toString().trim().length() == 0) {
            ...
            mSendButton.setClickable(false);
            mSendButton.setEnabled(false);
        } else if (mEmailAddressEditText.getText().toString().trim().length() > 1 && Utilities.isValidEmail(mEmailAddressEditText.getText().toString().trim())) {
