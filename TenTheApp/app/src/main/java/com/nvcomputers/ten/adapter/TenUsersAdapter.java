...
public class TenUsersAdapter extends RecyclerView.Adapter<TenUsersAdapter.ViewHolder> {

    private SharedPrefsHelper sharedPref;
    private BaseFragment baseFragment;
    private ContactsApi.UsersCallback usersCallback;
    private ArrayList<TenUsersResponse.User> mList;
    private BaseActivity mActivity;


    public TenUsersAdapter(BaseActivity context, ArrayList<?> mList, ContactsApi.UsersCallback usersCallback) {
    ...
    public TenUsersAdapter(BaseFragment baseFragment, ArrayList<?> mList, ContactsApi.UsersCallback usersCallback) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemLayoutView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.row_ten_users, null);
        // create ViewHolder
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.findViewById(R.id.rl_row_ten).setOnClickListener(this);
        }
            ...
            public void onResponse(Call<UnFollowResponse> call,
                ...
                if (response != null && response.body() != null) {
                    if (response.body().getSuccess().contains("true")) {
                        ...
                        usersCallback.notifyTenUsersList(position, R.string.friended_none);
                    }
                ...
                if (response != null && response.body() != null) {
                    if (response.body().getSuccess().contains("true")) {
                        if (mList.get(position).getIsPrivate() == null) {
                            ...
                            usersCallback.notifyTenUsersList(position, R.string.friended_friended);
                            notifyDataSetChanged();
                            ...
                            usersCallback.notifyTenUsersList(position, R.string.friended_pending);
                            notifyDataSetChanged();
                        } else {
                            mList.get(position).setFriended(mActivity.getString(R.string.friended_friended));
                            usersCallback.notifyTenUsersList(position, R.string.friended_friended);
                    ...
                    mActivity.showToast(response.message());
                }
            }
